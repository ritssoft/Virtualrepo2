...
using Virtual_Assistant_Template.Adapters;
using Virtual_Assistant_Template.Authentication;
using Virtual_Assistant_Template.Bots;
using Virtual_Assistant_Template.Dialogs;
using Virtual_Assistant_Template.Services;
using Virtual_Assistant_Template.TokenExchange;

namespace Virtual_Assistant_Template
{
